...
int main(){
    ...
    //!!!!!!!!!!!!!!!!!!!!!! change these later - on automated system, it is harder to get total avg value. leaving only sigInversion will work.
    // // totalAvg = getTotalAvg(sig);
    ...
    plt::plot(SEG_X_POS,SEG_Y_POS, "-");
    // // for(int i = 0; i < SEG_X_POS.size(); i++){
    // //     if(SEG_X_POS[i] > 2800 && SEG_X_POS[i] < 3200){
    // //         // cout << "seg_x_pos value: " << SEG_X_POS[i] << endl;
    // //     }
    // // }
    // // for(int i = 0; i < peaks.size(); i++){
    // //     if(peaks[i] > 2800 && peaks[i] < 3200){
    // //         // cout << "peaks value: " << peaks[i] << endl;
    // //     }
    // // }
